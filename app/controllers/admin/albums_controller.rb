class Admin::AlbumsController < Admin::BaseController
    ...
    if @album.save
			redirect_to admin_albums_path, success: 'Album created successfully'
		else
			render :new
		end
	end
	...
	def update
		if @album.update(album_params)
			redirect_to admin_albums_path, success: 'Album successfully updated'
		else
			render :edit
		end
	end
	...
	def destroy
      ...
      redirect_to root_path, danger: 'Permisson denied!'
	    ...
	    @album.destroy
		  redirect_to admin_albums_path, danger: 'Album deleted!'
	  end  
  end
