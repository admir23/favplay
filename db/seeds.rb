User.create!([
  ...
  {username: "admin2", email: "admin2@favplay.com", password:"password", password_confirmation: "password", role: 1, remember_digest: nil}
])
Genre.create!([
...
Artist.create!([
  ...
  {name: "Nirvana", artist_image: "http://www.billboard.com/files/styles/900_wide/public/media/kurt-cobain-charles-peterson-billboard-2-600.jpg", user_id: 5, genre_id: 5, artist_details: "Nirvana was an American rock band formed by singer and guitarist Kurt Cobain and bassist Krist Novoselic in Aberdeen, Washington, in 1987. Nirvana went through a succession of drummers, the longest-lasting being Dave Grohl, who joined in 1990. Despite releasing only three full-length studio albums in their seven-year career, Nirvana has come to be regarded as one of the most influential and important alternative bands in history. Though the band dissolved in 1994 after the death of Cobain, their music maintains a popular following and continues to influence modern rock and roll culture."},
...
Album.create!([
  {name: "DAMN", released: 2017, img_url: "http://www.xxlmag.com/files/2017/04/kendrick-lamar-damn-cover.jpeg", artist_id: 1, user_id: 5, genre_id: 1},
  {name: "Dangerous Woman", released: 2016, img_url: "https://upload.wikimedia.org/wikipedia/en/4/4b/Ariana_Grande_-_Dangerous_Woman_%28Official_Album_Cover%29.png", artist_id: 3, user_id: 5, genre_id: 4},
  ...
  {name: "Live at Reading", released: 2009, img_url: "https://images-na.ssl-images-amazon.com/images/I/81e5MBfOLhL._SY355_.jpg", artist_id: 7, user_id: 5, genre_id: 5}
])
Song.create!([
  ...
  {name: "Cosmic Girl", length: "4:05", genre_id: 6, album_id: 8, artist_id: 7, user_id: 4, youtube_link: "https://www.youtube.com/watch?v=UBnPedWPatI"},
  {name: "Come as You Are (Live at Reading 1992)", length: "3:36", genre_id: 5, album_id: 9, artist_id: 7, user_id: 5, youtube_link: "https://www.youtube.com/watch?v=NJqQf5DObtY", favorites_count: 1}
])
Playlist.create!([
